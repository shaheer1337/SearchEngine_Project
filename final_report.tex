...
\begin{titlepage}
  ...
  \vfill
  {\large Submission Date: [Fill Date]\par}
\end{titlepage}
...
\begin{figure}[!htbp]
  \centering
  \fbox{\parbox[c][2.0in][c]{0.92\linewidth}{\centering
  Insert terminal screenshot showing N=300 indexing completion and runtime.}}
...
\begin{figure}[!htbp]
  \centering
  \fbox{\parbox[c][2.0in][c]{0.92\linewidth}{\centering
  Insert terminal screenshot showing hidden-seed N=30 run and skip-on-rerun behavior.}}
...
\hline
[Member A] & [\%] & Spider/crawling and link graph logic \\
\hline
[Member B] & [\%] & Indexing/database schema and retrieval implementation \\
\hline
[Member C] & [\%] & Web interface, testing, documentation, and demo prep \\
\hline
\end{longtable}
